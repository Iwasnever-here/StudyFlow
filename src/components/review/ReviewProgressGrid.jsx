...
const ProgressBar = ({
  ...
  return (
    <div
      className="h-2.5 overflow-hidden rounded-full bg-(--bg-card)">
      <div
        className="
  ...
  return (
    <div
      className="
        ...
        bg-(--bg-input) px-4 py-6 text-center
...
const AcademicSummary = ({
  ...
  const hasAverageGrade = Number.isFinite(
    ...
    >
      <div className="space-y-4">
        ...
        >
          <div className="flex items-end justify-between gap-4">
            ...
            <p
              className=" pb-1 text-sm font-semibold
                text-(--text-muted)">
              {summary.completedCoursework}
              {' of '}
              {summary.totalCoursework}
              {' assignments'}
            </p>
          </div>
          ...
          <div className="mt-6">
            <ProgressBar
              value={summary.courseworkProgress}
            />
          </div>
        </div>
